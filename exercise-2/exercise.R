...
sentence <- tolower("Harry Potter is the movie about the wizard named Harry and his friends")
...
list_of_letters <- strsplit(sentence, "")

# Extract the vector of letters from the resulting list
letters <- list_of_letters[[1]]
...
count_occurrences <- function(letter, given_letters){
  length(given_letters[given_letters == letter])
}
